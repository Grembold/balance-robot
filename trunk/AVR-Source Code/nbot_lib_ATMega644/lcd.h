...
#define LCD_DATA_PORT		PORTB	/*!< Port on which the 4 LCD datapins are connected to */
#define LCD_DATA_OFFSET		4		/*!< Offset for data pins (e.g. 0 = PIN0..PIN3, 2 = PIN2..PIN5) */
#define LCD_CTRL_PORT		PORTB	/*!< PORT on which E1, E2, RS and RW are connected to */
...
#define LCD_WORD_WRAP 		0		/*!< Zeilenumbruch */
