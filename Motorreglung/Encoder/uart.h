...
#define BAUD 			19200  			/*!< Baudrate der UART-Kommunikation */
#define UBRR_BAUD	64						/*!< ((F_CPU)/((BAUD)*16L)-1) */
...
extern void uart_puti(int16_t i);		// sendet ein integer

extern int8_t uart_getc(void);			// empfange ein Zeichen
